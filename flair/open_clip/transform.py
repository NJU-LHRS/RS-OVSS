...
from torchvision.transforms import Normalize, Compose, RandomResizedCrop, InterpolationMode, ToTensor, Resize, \
    CenterCrop, ColorJitter, Grayscale, ConvertImageDtype
...
class DataAugmentationMulticrop(object):
    ...
    def __init__(self, mean, std, image_size, local_crops_number, local_method, crop_scale=0.14):
        self.local_crops_number = local_crops_number
        # self.local_crops_scale = (0.05, crop_scale)
        self.local_crops_scale = (0.3, 0.7)     # fixme:
    ...
    def __call__(self, image):
        ...
        # for idx in range(self.local_crops_number):
        #     i, j, h, w = RandomResizedCrop.get_params(image, scale=self.local_crops_scale, ratio=(3 / 4, 4 / 3))
        #     x1 = j / width
        #     y1 = i / height
        #     x2 = (j + w) / width
        #     y2 = (i + h) / height
...
def image_transform(
    ...
    if is_train:
        ...
        if use_timm:
            ...
            train_transform = DataAugmentationMulticrop(mean, std, image_size, max_boxes, local_method, crop_scale)
        else:
            train_transform = [
                # RandomResizedCrop(
                #     image_size,
